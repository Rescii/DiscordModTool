...
var Mongo = /** @class */ (function () {
    ...
    Mongo.prototype.setupOnce = function (_, getCurrentHub) {
        var collection;
        try {
            var mongodbModule = utils_1.dynamicRequire(module, 'mongodb');
            collection = mongodbModule.Collection;
        }
        catch (e) {
            utils_1.logger.error('Mongo Integration was unable to require `mongodb` package.');
            return;
        }
    ...
    Mongo.prototype._getSpanContextFromOperationArguments = function (collection, operation, args) {
        ...
        try {
            ...
            if (operation === 'mapReduce') {
                ...
                data[signature[0]] = typeof map === 'string' ? map : map.na